 ...
 * This Controller is devided into different classes where User class 
 * is used to det gata of user, DataValidator to validate user data 
 * then the functions will use those data for later process
 */
